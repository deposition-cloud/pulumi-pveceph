...
pulumi.runtime.registerResourceModule("pveceph", "index", _module)
pulumi.runtime.registerResourcePackage("pveceph", {
    version: utilities.getVersion(),
    constructProvider: (name: string, type: string, urn: string): pulumi.ProviderResource => {
        if (type !== "pulumi:providers:pveceph") {
